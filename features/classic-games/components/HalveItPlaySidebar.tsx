...
import { HalveItScoreboard } from "@/features/classic-games/components/HalveItScoreboard";
import type { HalveItGameState } from "@/types/halve-it";

interface HalveItPlaySidebarProps {
...
export function HalveItPlaySidebar({
  game,
  headerTitle,
  onBackClick,
  actionBar,
}: HalveItPlaySidebarProps) {
  return (
    <div className="match-play-sidebar flex h-full min-h-0 flex-col overflow-hidden">
      ...
      <div className="match-play-sidebar__body flex min-h-0 flex-1 flex-col overflow-hidden">
        <div className="match-play-sidebar__scoreboard flex min-h-0 flex-1 flex-col overflow-hidden px-0">
          <HalveItScoreboard game={game} compact fillHeight />
        </div>
