...
import { KillerScoreboard } from "@/features/classic-games/components/KillerScoreboard";
import type { KillerGameState } from "@/types/killer";

interface KillerPlaySidebarProps {
...
export function KillerPlaySidebar({
  game,
  headerTitle,
  onBackClick,
  actionBar,
}: KillerPlaySidebarProps) {
  return (
    <div className="match-play-sidebar flex h-full min-h-0 flex-col overflow-hidden">
      ...
      <div className="match-play-sidebar__body flex min-h-0 flex-1 flex-col overflow-hidden">
        <div className="match-play-sidebar__scoreboard flex min-h-0 flex-1 flex-col overflow-hidden px-0">
          <KillerScoreboard game={game} compact fillHeight />
        </div>
