...
/** Dedicated roster for sample Singles 501 League (no teams). */
export const SAMPLE_SINGLES_501_LEAGUE_ID = "sample-league-singles-501";

export const SAMPLE_SINGLES_501_PLAYERS: LeaguePlayer[] = [
  player({
    id: "lp-s501-jg",
    firstName: "Jason",
    lastName: "Gelsomino",
  ...
  player({
    ...
    losses: 2,
    average: 48.1,
    checkoutPercent: 29.5,
    highestCheckout: 100,
    count180s: 1,
    recentMatches: [],
    profileUserId: "sample-user-rm",
  }),
  player({
    id: "lp-s501-dw",
    firstName: "Devon",
  ...
  player({
    ...
    losses: 3,
    average: 44.8,
    checkoutPercent: 24.0,
    highestCheckout: 80,
    count180s: 0,
    recentMatches: [],
    profileUserId: "sample-user-sr",
  }),
  player({
    id: "lp-s501-ak",
    firstName: "Alex",
  ...
  player({
    ...
    losses: 3,
    average: 41.3,
    checkoutPercent: 22.5,
    highestCheckout: 70,
    count180s: 0,
    recentMatches: [],
    savedPlayerId: "sample-saved-rb",
  }),
];
...
export function getSampleLeaguePlayers(leagueId: string): LeaguePlayer[] {
  ...
  if (trimmed === SAMPLE_SINGLES_501_LEAGUE_ID) {
    return SAMPLE_SINGLES_501_PLAYERS.map((entry) => ({
      ...entry,
