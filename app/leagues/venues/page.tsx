...
export default function VenuesListPlaceholderPage() {
  return (
    <MobileAppShell className="organizations-page shell-page" title="Venues">
      <div className="organizations-screen">
        <GlassPanel>
          <h1 className="settings-panel__subheading text-2xl font-bold">All venues</h1>
          <p className="settings-panel__subdescription mt-2">
            Full venues list coming soon.
          </p>
